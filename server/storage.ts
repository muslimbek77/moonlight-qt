import { users, transactions, gamingSlots } from '../shared/schema';
import type { User, InsertUser, Transaction, InsertTransaction, GamingSlot, InsertGamingSlot } from '../shared/schema';
import { db } from './db';
